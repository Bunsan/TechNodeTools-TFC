...
{
    public static final String ModID = "technodetoolstfc";
    public static final String ModName = "TechNodeToolsTFC";
    ...
    public static final String SERVER_PROXY_CLASS = "com.technode.technodetoolstfc.core.proxy.ServerProxy";
    ...
    public static final String ConfigFileName = "TechNodeToolsTFC.cfg";
