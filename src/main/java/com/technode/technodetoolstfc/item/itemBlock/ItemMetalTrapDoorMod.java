...
public class ItemMetalTrapDoorMod extends ItemMetalTrapDoor
{
    public ItemMetalTrapDoorMod (Block par1)
    {
        super(par1);
    }
    @Override
    public boolean onItemUse(ItemStack itemstack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
    {
        if(!world.isRemote)
        {
            ...
            {
                if(world.setBlock(x, y, z, ModBlocks.metalTrapDoorMod))
                {
                    TEMetalTrapDoorMod te = (TEMetalTrapDoorMod) world.getTileEntity(x, y, z);
